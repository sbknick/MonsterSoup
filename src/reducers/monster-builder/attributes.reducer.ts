...
const AttributesReducer: Redux.Reducer<AttributesState> = (state: AttributesState = DEFAULT_STATE, action: Actions.AttributesAction) =>
{
    switch (action.type)
    {
...
const NewIncrementState: Redux.Reducer<AttributesState> = (state: AttributesState, action: Actions.IncrementAttributeAction) =>
{
    switch (action.attr)
    {
